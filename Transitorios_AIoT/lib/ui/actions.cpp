...
// 		lv_obj_set_style_bg_color(objects.bt_conectado_3_1, lv_color_hex(0x008000), LV_PART_MAIN | LV_STATE_DEFAULT);
// 		lv_obj_set_style_bg_color(objects.bt_conectado_3_2, lv_color_hex(0x008000), LV_PART_MAIN | LV_STATE_DEFAULT);
// 	} else {
...
// 		lv_obj_set_style_bg_color(objects.bt_conectado_3_1, lv_color_hex(0xFF0000), LV_PART_MAIN | LV_STATE_DEFAULT);
// 		lv_obj_set_style_bg_color(objects.bt_conectado_3_2, lv_color_hex(0xFF0000), LV_PART_MAIN | LV_STATE_DEFAULT);
// 	}
// }
